...
After completing the Principal Component Analysis (PCA), we obtain the dimensionally reduced data $\phi'(g_i)$. To identify potential malicious clients, the ViT-MGI algorithm uses the Isolation Forest algorithm to perform anomaly detection on these reduced data.
