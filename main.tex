...
\IEEEauthorblockN{
    ...
    Hao Hao\href{https://orcid.org/0000-0003-2765-3303}{\includegraphics[width=8pt]{pics/orcid.png}}$^2$ \\
    ...
    Tianhang Zhou\href{https://orcid.org/0000-0002-4007-9935}{\includegraphics[width=8pt]{pics/orcid.png}}$^3$\footnotemark\textsuperscript{\hyperref[fn:corresponding]{*}},
    Su Yao\href{https://orcid.org/0000-0001-5165-2787}{\includegraphics[width=8pt]{pics/orcid.png}}$^4$
}
\IEEEauthorblockA{
    \textit{$^1$School of Computer Science, Beijing University of Posts and Telecommunications, Beijing, China}\\
    \textit{$^2$Shandong Academy of Sciences \& National Supercomputing Center in Jinan, China}\\
    \textit{$^3$College of Carbon Neutrality Future Technology, State Key Laboratory of Heavy Oil Processing,}\\
    \textit{China University of Petroleum (Beijing), Beijing 102249, China}\\
    \textit{$^4$Beijing National Research Center for Information Science and Technology, Tsinghua University, Beijing, China}
}
}
...
\footnotetext[1]{Corresponding author:\label{fn:corresponding} \href{mailto:zan.zhou@bupt.edu.cn}{zan.zhou@bupt.edu.cn}, \href{mailto:zhouth@cup.edu.cn}{zhouth@cup.edu.cn}}
...
% \vspace{-5em}  % 这里要么太少(≤5)没变化，要么太大(>6)直接和上一段重合了
...
This work was supported in part by the Fundamental Research Funds for the Central Universities under Grant 2024ZCJH04, China Postdoctoral Science Foundation (grant No. 2024M750259), Beijing Natural Science Foundation (grant No. 4244084), National Natural Science Foundation of China (under grant No. 62472240, grant No. 62401075, No. 62394322, No. 62471066, No. 61932016, No. 62132011, No. 62132009, No. 92167204, No. U22B203).
...
% \end{thebibliography}
% \balance  % 又加了一位作者后，balance无法对齐最后两栏，右边参考文献比左边多几行。
