...
LastEditTime: 2024-07-13 18:33:12
...
class Config:
    def __init__(self, now: str):
        ...
        self.attackMethod = "lable"     # 攻击方式：grad、lable、backdoor
        self.ifPooling =  False         # 是否进行池化操作
        self.ifUsefulLayer=True        #是否仅仅使用有用的层
        ...
        self.correct_receive = 0
        self.wrong_receive = 0
        self.correct_reject = 0
        self.wrong_reject = 0
        self.parseAgrs()
        self.saveConfig()
